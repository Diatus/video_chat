...
class JoinChannelVideo extends StatefulWidget {
  ...
  JoinChannelVideo(this.snapshot);
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text('${snapshot.data['celebrity']}', style: GoogleFonts.poppins(color: Colors.white,fontWeight: FontWeight.w500,fontSize: 24,),),
                          ),
                          ...
                          Row(crossAxisAlignment: CrossAxisAlignment.center,mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Container(width: MediaQuery.of(context).size.width*0.35,alignment: Alignment.centerRight,
                              ...
                              SizedBox(width: 32,),
                              CircleAvatar(radius: 25,backgroundColor: Color(0xff000000).withOpacity(0.5),
                                child: IconButton(icon: Icon(Icons.mic_off_rounded,color: Colors.white),
                                    onPressed: (){
